"""
    config file of the medium version of CondLaneNet for curvelanes
"""
# global settings
...
data = dict(
    samples_per_gpu=
    batch_size,  # 4 for larger GPU memory,  2 is OK for 8GB GPU memory
    workers_per_gpu=4,
    train=dict(
        type=dataset_type,
...
log_level = 'INFO'
work_dir = './work_dirs/exps/curvelanes/medium'
load_from = None
resume_from = None
